package com.andry72.telega.Fragments;
...
import com.andry72.telega.Model.User;
import com.andry72.telega.R;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        details_et = view.findViewById(R.id.details_et);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                details_et.setEnabled(false);


                reference.child("details").setValue(details_et.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                details_et.setText(user.getDetails());
